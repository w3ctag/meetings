...
(\url{https://lists.w3.org/Archives/Public/public-webappsec/2015Feb/0309.html} maybe?)
...
\url{https://github.com/w3ctag/spec-reviews/issues/77}
Alex: did we mean to bring this up with WebAppSec folks?  Oh well.

### Advice for Spec Authors
\url{https://github.com/w3ctag/spec-reviews/issues/78}
...
\url{https://github.com/w3ctag/spec-reviews/issues/80}
...
### Automotive WG
\url{https://github.com/w3ctag/spec-reviews/issues/81}
Domenic's Design Document (DDD): \url{http://w3ctag.github.io/design-principles/}
...
### storage persistence
\url{https://github.com/w3ctag/spec-reviews/issues/85}
...
## FIDO
See \url{https://www.w3.org/Submission/2015/02/} 
...
\url{https://www.w3.org/Submission/2015/SUBM-fido-web-api-20151120/}
...
Travis: now reading the page about keygen <\url{http://w3ctag.github.io/client-certificates/}> Section 6 is about requirements for a keygen replacement.
...
\url{https://www.w3.org/Submission/2015/SUBM-fido-signature-format-20151120/}
...
David: There are interfaces in both specs called Credential.  \url{http://w3c.github.io/webappsec-credential-management/#credential} \url{http://www.w3.org/Submission/fido-web-api/#api}  There is also a mismatch between Credentials (FIDO and credential management), 'id' and 'type' not having the same types.
...
put in \url{https://github.com/w3ctag/spec-reviews/issues/97}
...
\url{https://github.com/w3ctag/wiki/wiki/Shutdown}
...
[Network Information API](<\url{https://github.com/w3ctag/spec-reviews/issues/86}>)
...
[Review FormData additions in XHR](<\url{https://github.com/w3ctag/spec-reviews/issues/87}>)
...
[Feedback on DOMError -> DOMException in Indexed DB](<\url{https://github.com/w3ctag/spec-reviews/issues/88}>)

alex: looks great, lets do it, make a note to ourselves to include in our doc for spec authors

[Geofencing FPWG](<\url{https://github.com/w3ctag/spec-reviews/issues/89}>)

<defer until hadley available>

[Bluetooth API Security Model](<\url{https://github.com/w3ctag/spec-reviews/issues/90}>)
...
[Streams General issue](\url{https://github.com/w3ctag/spec-reviews/issues/92)}
