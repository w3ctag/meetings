...
Mike West update: 9:00 - 10:00
 ...
 - \url{https://github.com/w3ctag/spec-reviews/issues/74}
...
[EME Secure Release](\url{https://github.com/w3ctag/spec-reviews/issues/73)}

15:30 - 17:00

Brainstorm IA for the TAG's web site(s)
\url{https://github.com/w3ctag/spec-reviews/issues/53}
...
## Issue 14: WebRTC: \url{https://github.com/w3ctag/spec-reviews/issues/14}
...
## Issue 18: Navigation Timing 2: \url{https://github.com/w3ctag/spec-reviews/issues/18}
...
... safari implement some but not other. (yes \url{http://caniuse.com/#feat=nav-timing} vs. no \url{http://caniuse.com/#feat=resource-timing} )
...
... when I read it in TPAC 2015, there still seemed to have a lot of issues. It's still early. Latest draft is at: \url{http://w3c.github.io/performance-timeline/#the-performance-observer-interface}. Implementation status on Chromium tracker shows it as early days: \url{https://www.chromestatus.com/feature/5945504202489856}
Travis: might be good to update the title. [Done]
We should come back to this, but don't need to do so in the short term.

## Issue 38: Browser Fingerprinting Document: \url{https://github.com/w3ctag/spec-reviews/issues/38}
...
Alex: looks like it's mostly identical; have pinged our review thread and opened an issue on their repo to plead for discussion at an upcoming telecon: \url{https://github.com/w3c/fingerprinting-guidance/issues/9}

## Issue 42: CSP: \url{https://github.com/w3ctag/spec-reviews/issues/42}
...
## Issue 49: Credential Management API: \url{https://github.com/w3ctag/spec-reviews/issues/49}
...
## Packaging on the Web \url{https://github.com/w3ctag/packaging-on-the-web}
...
yves: digi-pub group looked at it, considered it, but given lack of stability assurance on the doc, they weren't confident to use it.
   ...
   * 
## Design Principles \url{https://github.com/w3ctag/design-principles}
...
## Security Questionaire: \url{https://github.com/w3ctag/spec-reviews/issues/77}
\url{https://www.w3.org/TR/2015/NOTE-security-privacy-questionnaire-20151210/}
...
## Promises Guide: \url{https://github.com/w3ctag/promises-guide} (does it need any update?)
...
Travis: Let's create an issue and assign it to me. I'll start by gathering information on it. [Created: \url{https://github.com/w3ctag/spec-reviews/issues/100}]
...
======Lunch=====
   ...
   * ##Report Card (update? close it and declare success?)
   * 
\url{https://github.com/w3ctag/extensible-web-report-card}
\url{https://github.com/w3ctag/extensible-web-report-card/issues}
...
\url{https://github.com/w3ctag/spec-reviews/issues/49}
...
\url{https://github.com/w3ctag/spec-reviews/issues/51}
...
\url{https://github.com/w3ctag/spec-reviews/issues?q=is%3Aissue+is%3Aopen+sort%3Acreated-asc}
...
\url{https://github.com/w3ctag/spec-reviews/issues/63}
...
...So this becomes the spec review issue for reviewing the Web Script-based Accessibility Spec: \url{https://github.com/cyns/wapa}
...I'll write the notes and change the issue name.


## Cross-spec device identification \& association #64

\url{https://github.com/w3ctag/spec-reviews/issues/64}
...
\url{https://github.com/w3ctag/spec-reviews/issues/66}
...
## requestIdleCallback
\url{https://github.com/w3ctag/spec-reviews/issues/70}
...
dbaron: \url{https://html.spec.whatwg.org/multipage/webappapis.html#dom-window-requestanimationframe} does sequential IDs different from setTimeout
...
# CSS font-display
\url{https://github.com/w3ctag/spec-reviews/issues/71}
...
## task scheduling
\url{https://github.com/w3ctag/spec-reviews/issues/72}
travis: oops, looks like we just created a dupe of this at #100

## Secure Stop
\url{https://github.com/w3ctag/spec-reviews/issues/73}
...
\url{https://github.com/w3ctag/spec-reviews/issues/75}
also talk tomorrow morning


## With Credentials flag
\url{https://github.com/w3ctag/spec-reviews/issues/76}
...
looking at \url{http://www.bom.gov.au/vic/observations/melbourne.shtml}
